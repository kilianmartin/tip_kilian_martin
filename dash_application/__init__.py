...
def k5_fetch():
    ...
    endpoints = [k5_endpoint_1, k5_endpoint_2, k5_endpoint_3]
...
def create_dash_kpi3(flask_app):
    ...
    dash_app.layout = html.Div(children=[
        html.H1(children='KPI3 - Jan 2018'),
        ...
        html.H1(children='KPI3 - Feb 2018'),
        ...
        html.H1(children='KPI3 - Mar 2018'),
...
def create_dash_kpi5_constructor(k5_dict):
    ...
    for month in k5_dict.keys():
        children.append(html.H1(children=month))
        
        for service in k5_dict[month].keys():
            children.append(html.H2(children=service))
            
            kpis = k5_dict[month][service]

            children.append(html.P(children=f'Downtime: {kpis[0]} mins'))
            ...
            children.append(dcc.Graph(
                ...
                .update_yaxes(showticklabels=False, title_font_color="#FFFFFF")))
